...
import ModalExampleSource from '../examples/Modal.txt';

import ModalBackdropExample from '../examples/ModalBackdrop';
import ModalBackdropExampleSource from '../examples/ModalBackdrop.txt';

import ModalNestedExample from '../examples/ModalNested';
import ModalNestedExampleSource from '../examples/ModalNested.txt';

import ModalCustomTimeoutExample from '../examples/ModalCustomTimeout';
import ModalCustomTimeoutExampleSource from '../examples/ModalCustomTimeout.txt';

import ModalFadelessExample from '../examples/ModalFadeless';
import ModalFadelessExampleSource from '../examples/ModalFadeless.txt';
