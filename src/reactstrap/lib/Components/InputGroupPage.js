...
import OverviewExampleSource from '../examples/InputGroupOverview.txt';
import AddonExample from '../examples/InputGroupAddon';
import AddonExampleSource from '../examples/InputGroupAddon.txt';
import AddonSizingExample from '../examples/InputGroupSizing';
import AddonSizingExampleSource from '../examples/InputGroupSizing.txt';
import ButtonExample from '../examples/InputGroupButton';
import ButtonExampleSource from '../examples/InputGroupButton.txt';
